export const NOT_MEMBER_YET = '아직 회원이 아니신가요?';
...
export const PARTICIPANT_FORM = {
  ...
  CONFIRM: '승인하기',
  CONFIRM_YN: '승인 여부',
  NO_EXIST_PARTICIPANT: '신청자가 존재하지 않습니다.',
};
...
export const INTRODUCE_FORM_TITLE = {
  APPLY_STATUS: '신청 현황 :',
  DEAD_LINE_DATE: '모집 마감 일자 :',
  INTRODUCE: '소개',
};

export const MODERATOR_STATUS = {
  CONDUCT_STUDY: '스터디를 진행해주세요!',
  CONFIRM_STUDY: '스터디 참여 승인하기',
};
